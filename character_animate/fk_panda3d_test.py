from show_charactor import SimpleViewer
import numpy as np
...
def part2_one_pose(viewer, bvh_file_path):
    ...
    viewer.show_pose(joint_name, joint_positions/40, joint_orientations)
    viewer.run()
...
def part2_animation(viewer, bvh_file_path):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer_):
            ...
            viewer.show_pose(joint_name, joint_positions/80, joint_orientations)
...
def main():
    # create a viewer
    viewer = SimpleViewer()
    bvh_file_path = "data/lafan1/run1_subject5.bvh"
    ...
    #part2_one_pose(viewer, "data/test.bvh")
    part2_animation(viewer, bvh_file_path)
    # part3
